...
const tours = JSON.parse(fs.readFileSync(`${__dirname}/../assets/data/tours-simple.json`));
/*
...
const createTour = (req, res) => {
    ...
    fs.writeFile(`${__dirname}/../assets/data/tours-simple.json`, JSON.stringify(tours), (err) => {
        res.status(201).json({
            status: 'success',
            data: {
                tour: newTour,
